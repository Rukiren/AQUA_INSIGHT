    ...
    for i in name_list: 
        ...
        # Filtering out the "下属物种" section
            ...
            for j in range(len(title_list)):
                animal_dict[label]["info"][title_list[j]] = content_list[j]
                
        else:
            print("Wiki - {} 資料抓取失敗".format(i))
            title_list.append("None data")
            content_list.append("None data")
            
            animal_dict[label]["info"]["None data"] = None
